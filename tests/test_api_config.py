...
class TestApiConfig(unittest.TestCase):
    ...
    def test_configure_api_success(self, mock_load_dotenv, mock_generative_model, mock_genai_configure, mock_os_getenv):
    ...
    @patch('src.core.api_config.os.getenv')
    @patch('src.core.api_config.load_dotenv')
    def test_configure_api_key_not_found(self, mock_load_dotenv, mock_os_getenv):
