...
class TestDatabase(unittest.TestCase):
    ...
    def test_get_db_config_success(self, mock_abspath, mock_dirname, mock_json_load, mock_open_file) -> None:
    ...
    @patch("os.path.dirname")  # Patch os.path.dirname
    @patch("os.path.abspath")  # Patch os.path.abspath
    def test_get_db_config_file_not_found(self, mock_abspath, mock_dirname, mock_json_load, mock_open_file) -> None:
    ...
    @patch("os.path.dirname")  # Patch os.path.dirname
    @patch("os.path.abspath")  # Patch os.path.abspath
    def test_get_db_config_invalid_json(self, mock_abspath, mock_dirname, mock_json_load, mock_open_file) -> None:
    ...
    def test_get_db_connection_success(self, mock_getenv, mock_sqlite_connect, mock_get_db_config) -> None:
    ...
    @patch("src.core.database.sqlite3.connect")
    @patch("src.core.database.os.getenv")
    def test_get_db_connection_failure(self, mock_getenv, mock_sqlite_connect, mock_get_db_config) -> None:
        """Tests database connection failure."""
        # Arrange
        mock_get_db_config.return_value = {"database_file": "default.db"}
        mock_getenv.return_value = "my_test_db.db"
        mock_sqlite_connect.side_effect = database.sqlite3.Error(
    ...
    def test_create_summary_table_success(self, mock_get_db_connection, mock_get_db_config) -> None:
    ...
    @patch("src.core.database.get_db_config")
    def test_create_summary_table_missing_config(self, mock_get_db_config) -> None:
    ...
    @patch("src.core.database.get_db_connection")
    @patch("src.core.database.get_db_config")
    def test_save_summary_to_db_success(self, mock_get_db_config, mock_get_db_connection, mock_create_summary_table, mock_datetime) -> None:
    ...
    @patch("src.core.database.get_db_connection")
    @patch("src.core.database.get_db_config")
    def test_get_summaries_success(self, mock_get_db_config, mock_get_db_connection) -> None:
        ...
        summaries = database.get_summaries(
            limit=5, url_contains="example", style="bullet_points"
        )
