...
class TestTextExtraction(unittest.TestCase):
    """Tests for the text_extraction module."""

    @patch("src.core.text_extraction.requests.get")
    def test_extract_text_from_url_success(self, mock_requests_get) -> None:
        ...
        mock_requests_get.assert_called_once_with(
            "http://example.com", headers=unittest.mock.ANY, timeout=15
        )

    @patch("src.core.text_extraction.os.path.exists")
    @patch("src.core.text_extraction._extract_text_from_pdf")
    def test_extract_text_delegates_to_pdf_extractor(self, mock_pdf_extractor, mock_exists) -> None:
    ...
    @patch("src.core.text_extraction.os.path.exists")
    def test_extract_text_source_not_found(self, mock_exists) -> None:
    ...
    @patch("src.core.text_extraction.requests.get")
    def test_extract_text_from_url_fallback(self, mock_requests_get) -> None:
    ...
    @patch("src.core.text_extraction.requests.get")
    def test_extract_text_from_url_http_error(self, mock_requests_get) -> None:
    ...
    def test_extract_text_delegates_to_docx_extractor(self, mock_docx_extractor, mock_exists) -> None:
    ...
    def test_extract_text_delegates_to_xlsx_extractor(self, mock_xlsx_extractor, mock_exists) -> None:
    ...
    @patch("src.core.text_extraction.os.path.exists")
    def test_extract_text_unsupported_file_type(self, mock_exists) -> None:
