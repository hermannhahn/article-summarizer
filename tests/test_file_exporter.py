...
class TestFileExporter(unittest.TestCase):
    """Tests for the file_exporter module."""

    def test_save_as_txt(self) -> None:
    ...
    def test_save_as_pdf(self, mock_fpdf) -> None:
    ...
    def test_save_as_docx(self, mock_document) -> None:
    ...
    def test_save_as_image(
        ...
        mock_font_instance.getbbox.return_value = (
            0,
            0,
            100,
            15,
        )  # (left, top, right, bottom) for a character
        ...
        mock_draw_instance.textbbox.side_effect = lambda pos, text, font: (
            0,
            0,
            len(text) * 10,
            15,
        ...
        expected_calls = [
            call(
                unittest.mock.ANY,
                "This is a very long sentence that should definitely wrap into",
